...
function Calendar(element, options, eventSources, resourceSources) {
	...
	function prev() {
	    setTimeout(function () { renderView(-1); }, 1000);
	}
...
function BasicView(element, calendar, viewName) {
	...
	function buildTable(showNumbers) {
		...
		html += "<table class='fc-border-separate' style='width:100%' cellspacing='0'><col width='200'>" +
		        "<thead>" +
		        "<tr>";
...
function ResourceView(element, calendar, viewName) {
	...
	function buildSkeleton(maxRowCnt, showNumbers) {
		...
		s =
			"<table class='fc-border-separate' style='width:100%' cellspacing='0'><col width='200'>" +
			"<thead>" +
