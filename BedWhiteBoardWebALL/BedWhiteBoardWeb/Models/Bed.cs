...
namespace BedManagement
{
    public class Bed
    {
        ...
        public int admissionrequested { get; set; }

        public string pat_location { get; set; }

        public string location_type { get; set; }

        public string investigation_type { get; set; }
        ...
        public static Bed MappingER(IDataReader dr) => new Bed()
        {
            ...
            admissionrequested = dr["admissionrequested"] is DBNull ? 0 : int.Parse(dr["admissionrequested"].ToString()),
            pat_location = dr["pat_location"] is DBNull ? "" : dr["pat_location"].ToString(),
            location_type = dr["location_type"] is DBNull ? "" : dr["location_type"].ToString(),
            investigation_type = dr["investigation_type"] is DBNull ? "" : dr["investigation_type"].ToString(),
            admitted = dr["admitted"] is DBNull ? 0 : int.Parse(dr["admitted"].ToString()),
            score = dr["score"] is DBNull ? "" : dr["score"].ToString(),
            refwaitintime = dr["refwaitintime"] is DBNull ? "" : dr["refwaitintime"].ToString()
        };

        public static Bed Mapping(IDataReader dr) => new Bed()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
            parent_key = dr["parent_key"] is DBNull ? 0 : int.Parse(dr["parent_key"].ToString()),
            maintainance = dr["maintaince"] is DBNull ? 0 : int.Parse(dr["maintaince"].ToString()),
        ...
        public static Bed MappingRB(IDataReader dr) => new Bed()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
            parent_key = dr["parent_key"] is DBNull ? 0 : int.Parse(dr["parent_key"].ToString()),
            active = dr["active"] is DBNull ? 0 : int.Parse(dr["active"].ToString()),
        ...
        public static Bed MappingOP(IDataReader dr) => new Bed()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
        ...
        public static Bed MappingStatus(IDataReader dr) => new Bed()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
        ...
        public static Bed MappingLocation(IDataReader dr) => new Bed()
        {
