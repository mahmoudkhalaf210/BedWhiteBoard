...
namespace BedManagement
{
    public class bedNotdetail
    {
        ...
        public static bedNotdetail MappingER(IDataReader dr) => new bedNotdetail()
        {
        ...
        public static bedNotdetail Mapping(IDataReader dr) => new bedNotdetail()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
            parent_key = dr["parent_key"] is DBNull ? 0 : int.Parse(dr["parent_key"].ToString()),
            maintainance = dr["maintaince"] is DBNull ? 0 : int.Parse(dr["maintaince"].ToString()),
        ...
        public static bedNotdetail MappingRB(IDataReader dr) => new bedNotdetail()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
            parent_key = dr["parent_key"] is DBNull ? 0 : int.Parse(dr["parent_key"].ToString()),
            active = dr["active"] is DBNull ? 0 : int.Parse(dr["active"].ToString()),
        ...
        public static bedNotdetail MappingOP(IDataReader dr) => new bedNotdetail()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
        ...
        public static bedNotdetail MappingStatus(IDataReader dr) => new bedNotdetail()
        {
            sys_key = dr["sys_key"] is DBNull ? 0 : int.Parse(dr["sys_key"].ToString()),
        ...
        public static bedNotdetail MappingLocation(IDataReader dr) => new bedNotdetail()
        {
