<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="ERWhiteBoard.aspx.cs" Inherits="BedWhiteBoard.ERPage" %>
...
<%--    <link href='http://fonts.googleapis.com/css?family=Oswald:300,400,700|Open+Sans:400,700,300|Roboto:100,300,400,700|Roboto+Condensed:300,400,700' rel='stylesheet' type='text/css'>--%>
  ...
  <![endif]-->
   ...
   <%-- <script src="Scripts/jquery.signalR-1.1.3.js"></script>--%>
    ...
    <script src="Scripts/tsorter.js"></script>
    ...
    <script src="Scripts/er-management.js"></script>
                            ...
                            <div id="divNurseStations" class="content-wrapper">
                                <div id="erToolBar" style="display: none;">
                                    <table style="width: 100%;">
                                        <tr>
                                            <td>
                                                <div class="top-search-w pull-left" style="margin-top: -4px; margin-right: 5px;">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <label class="title_lable">Find Patient Location</label>
                                                            </td>
                                                            <td>

                                                                <div class="input-group input-group-sm">
                                                                    <input id="txtGeneralSearch" type="text"  style="width: 100px; padding: 4px;" class="top-search form-control input-sm" placeholder="Search" />
                                                                    <span style="width: 20px; display: inline-block;" class="input-group-addon"> <img style="margin-left: -7px; margin-top: -4px;" src="assets/images/find.png" /> </span>
                                                                    <span style="width: 400px; display: inline-block;" id="lblSearchResult" class="input-group-addon">Location</span>
                        ...
                        <table class="table" data-area="main_header_area">
                            ...
                            <tbody>
                                <tr data-bind="attr: { id: 'try_col' + sys_key() }">
                                    ...
                                    <td>
                                        <img src="assets/images/beacon_light.gif" alt=""></td>
                                    <td>
                                    ...
                                    <div class="widget-content fixedhight_contant" style="overflow-y: auto;">
                                        <div class="panelfullwidth">
                                            <table data-bind="attr: { id: 'tblWP' + sys_key() }" class="table">
                                                <thead data-bind="sort: { list: sortedWaitingPatients, alwaysBy: 'patient_id' }">
                                                    <tr class="t_header">
                                                        ...
                                                        <th data-sort-by="patient_id()" style="margin: 0; text-align: center; vertical-align: middle;">NHS/ MRN</th>
                                                        <th data-sort-by="patengname()" style="margin: 0; text-align: center; vertical-align: middle;">Patient Name</th>
                                                ...
                                                <tbody style="white-space: nowrap;" data-bind="foreach: sortedWaitingPatients">
                                                    ...
                                                    <!-- /ko -->
                                                    <!-- ko case: $default -->
                                                    <tr  data-bind="attr: { 'id': 'cxWP' + patient_id() }" class="cnxMnuWp"></tr>
                                                    <!-- /ko -->
                                                    <!-- /ko -->
                                                    ...
                                                    <tr data-bind="attr: { 'id': 'wp' + patient_id(), 'class': 'bedTabular ' + sex() }, click: wpClick, event: { 'contextmenu': WpRightClick }">
                                                        ...
                                                        <td style="margin: 0; text-align: center;">
                                                            <span data-bind="text: age, attr: { title: age }"></span>
                            ...
                            <div class="col-md-5" data-bind="attr: { id: 'try_extb' + sys_key() }">
                                <div class="widget widget-blue" data-bind="if: $root.SelectedERNs()">
                                    ...
                                    <div class="widget-title">
                                        ...
                                        <div class="widget-controls" style="cursor: pointer;" title="Refresh In Treatment">
                                            <div class="widget-control widget-control-refresh extend_div" title="Refresh In Treatment" data-bind="click: RefreshAllTrt" data-toggle="tooltip" data-placement="top" title="" data-original-title="Refresh"><i style="margin-right: 5px; margin-left: 5px;" class="icon-refresh"></i></div>
                                        </div>
...
<%--                            <col width="10%">
        ...
        <div class="modal fade" id="diagTriageSheet" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
            <div class="modal-dialog" style="font-size: 12px; width: 98%;">
                <div class="modal-content">
                    <div class="widget widget-blue">

                        <div class="widget-title">
                            <div class="widget-controls" >
                                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" style="padding: 0; margin: 0;background-color: transparent; background-image: none; border: none; box-shadow: none;" onclick="ModalSheetClose();">
                                    <img src="assets/images/cancel.png" /></button>
                            </div>
                            <h3>
                                <img src="assets/images/hide_detail.png" width="16px" height="16px" />Triage Patient Assessment
                            </h3>
                        ...
                        <div class="widget-content">
                            <div class="modal-body">
                                <iframe id="framTriageSheet" style="width: 100%; height: 80vh;border: none;" class="iframe-placeholder" >
        ...
        <div class="modal fade" id="diagRequestAdmission" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
            <div class="modal-dialog" style="font-size: 12px; width: 98%;">
                <div class="modal-content">
                    <div class="widget widget-blue">
                        ...
                        <div class="widget-title">
                            <div class="widget-controls" >
                                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="ModalRequestAdmissionClose();" style="padding: 0; margin: 0;background-color: transparent; background-image: none; border: none; box-shadow: none;" onclick="ModalRequestAdmissionClose();">
                                    <img src="assets/images/cancel.png" /></button>
                            </div>
                            <h3>
                                <img src="assets/images/hide_detail.png" width="16px" height="16px" />Admission Request</span>
                            </h3>
                        ...
                        <div class="widget-content">
                            <div class="modal-body">
                                <iframe id="framRequestAdmission" style="width: 100%; height: 80vh;border: none;" class="iframe-placeholder" >
         ...
         <div class="modal" id="diagCancelReg" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
            <div class="modal-dialog" style="width: 60%;height: 350px;">
                <div class="modal-content">
                    <div class="widget widget-blue">
                        <div class="widget-title">
                            <div class="widget-controls">
                                <button type="button" class="close" data-dismiss="modal" onclick=" $('#diagCancelReg').modal('hide');" style="opacity:1;margin-right: 0;">
                                    <img src="../MPlusReferences/assets/images/cancel.png">
                                </button>
                            </div>
                            <h3><i class="icon-ok-sign"></i>Cancel Registration</h3>
                        </div>
                        <div class="widget-content">
                            <div class="modal-body">
                                <iframe id="framCancelReg" style="width: 100%; height: 350px;"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
